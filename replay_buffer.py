...
class UniformReplayBuffer:
    def __init__(self, burnin, capacity, gamma, n_step, parallel_envs, use_amp, is_test):
    ...
    def sample(self, batch_size, beta=None):
        ...
        return prep_observation_for_qnet(state, self.use_amp, self.test), prep_observation_for_qnet(next_state, self.use_amp, self.test), \
...
class PrioritizedReplayBuffer:
    ...
    def __init__(self, burnin: int, capacity: int, gamma: float, n_step: int, parallel_envs: int, use_amp, is_test):
        self.burnin = burnin
